 ...
 *
 * GET /api/chemistry/v2/compounds - List all compounds
 * GET /api/chemistry/v2/compounds?q=water - Search by name/formula
 * GET /api/chemistry/v2/compounds?category=acid - Filter by category
 * GET /api/chemistry/v2/compounds?id=h2o - Get specific compound
 *
 * Created: 2026-01-29
...
export async function GET(request: NextRequest) {
  const limited = publicApiV2RateLimit(request, 'compounds');
