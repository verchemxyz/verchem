 ...
 *
 * GET /api/chemistry/v2/ph?h=0.001 - Calculate from H+ concentration
 * GET /api/chemistry/v2/ph?oh=0.00001 - Calculate from OH- concentration
 * GET /api/chemistry/v2/ph?poh=5 - Calculate from pOH
 * GET /api/chemistry/v2/ph?ph=7 - Get all related values
...
export async function GET(request: NextRequest) {
  const limited = publicApiV2RateLimit(request, 'ph');
    ...
    return publicApiJson(
      {
        ...
        examples: [
          '/api/chemistry/v2/ph?h=0.001',
          '/api/chemistry/v2/ph?oh=0.00001',
          '/api/chemistry/v2/ph?ph=7',
          '/api/chemistry/v2/ph?poh=5',
        ],
      },
      { status: 400 }
    );
