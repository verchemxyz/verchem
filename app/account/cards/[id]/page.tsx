      ...
      <Card className="p-5 space-y-4">
        ...
        <div className="pt-2 border-t border-border">
          <button
            ...
            disabled={busy}
            className="inline-flex items-center gap-2 rounded-md border border-destructive/30 px-4 py-2 text-sm font-medium text-destructive transition-colors hover:bg-destructive/10 disabled:opacity-50"
          >
