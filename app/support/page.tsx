              ...
              {isCustom && (
                <div className="flex items-center gap-2">
                  ...
                  <input
                    ...
                    className="w-24 px-3 py-2 rounded-lg bg-white dark:bg-neutral-800 border border-border text-gray-900 dark:text-gray-100 placeholder:text-gray-400 dark:placeholder:text-gray-500 focus:ring-2 focus:ring-primary-500 focus:outline-none"
                  />
                </div>
              )}
            </div>
