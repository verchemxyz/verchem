    ...
    return (
      <div className="border-b border-border pb-4">
        <button
          ...
          className="flex items-center justify-between w-full text-left font-medium text-foreground hover:text-primary-600 transition-colors"
        >
          <span>{title}</span>
          {isExpanded ? (
          ...
          <div>
            ...
            <div className="flex space-x-2">
              <input
                ...
                className="w-full px-3 py-1 text-sm border border-border rounded bg-card text-foreground placeholder-muted-foreground focus:ring-primary-500 focus:border-primary-500"
              />
              ...
              {['flammable', 'toxic', 'corrosive', 'oxidizer', 'explosive'].map(hazard => (
                <label key={hazard} className="flex items-center">
                  <input
                    ...
                    className="h-4 w-4 text-primary-600 focus:ring-primary-500 border-border rounded"
                  />
                  <span className="ml-2 text-sm text-foreground capitalize">{hazard}</span>
                </label>
              ))}
            </div>
          </div>
              ...
              {['s', 'p', 'd', 'f'].map(block => (
                <label key={block} className="flex items-center">
                  <input
                    ...
                    className="h-4 w-4 text-primary-600 focus:ring-primary-500 border-border rounded"
                  />
                  <span className="ml-2 text-sm text-foreground">{block.toUpperCase()} Block</span>
                </label>
              ))}
            </div>
          </div>
